...
.github/workflows/sprint-report.yml   # scheduled run (repo root)
```

This tool lives under `tools/sprint-report-agent/` as part of the TPM-Agent toolkit — see the [repo root README](../../README.md) for the full list of tools.
