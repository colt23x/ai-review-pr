...
const (
	...
	StepPlaybookSafety StepName = "playbook-safety"
...
func AllSteps() []StepName {
	return []StepName{StepIntent, StepRebase, StepReview, StepTest, StepDocument, StepLint, StepPlaybookSafety, StepPush, StepPR, StepCI}
}
